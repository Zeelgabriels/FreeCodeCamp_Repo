...
The goal is to learn to leverage HyperText Markup Language to create the content and structure of a web page.
...
Single-line comment is structured this way: <!--"comment"-->
Multi-line comments is structured this way:
<!--
"comments"
-->
...
Inside the existing img element, add a src attribute with this URL:https://cdn.freecodecamp.org/curriculum/cat-photo-app/relaxing-cat.jpg
